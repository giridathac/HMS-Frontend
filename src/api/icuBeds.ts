...
const stubICUBeds: ICUBed[] = [
  { id: 1, icuBedId: 1, icuId: 1, icuBedNo: 'B01', icuType: 'Medical', icuRoomNameNo: 'R101', icuDescription: 'Medical ICU bed with ventilator support', isVentilatorAttached: true, status: 'active', createdAt: '2025-01-01T10:00:00Z', createdDate: '2025-01-01' },
  { id: 2, icuBedId: 2, icuId: 2, icuBedNo: 'B02', icuType: 'Surgical', icuRoomNameNo: 'R101', icuDescription: 'Surgical ICU bed', isVentilatorAttached: false, status: 'active', createdAt: '2025-01-01T10:00:00Z', createdDate: '2025-01-01' },
  { id: 3, icuBedId: 3, icuId: 3, icuBedNo: 'B03', icuType: 'Pediatric', icuRoomNameNo: 'R102', icuDescription: 'Pediatric ICU bed with specialized equipment', isVentilatorAttached: true, status: 'active', createdAt: '2025-01-01T10:00:00Z', createdDate: '2025-01-01' },
  { id: 4, icuBedId: 4, icuId: 4, icuBedNo: 'B04', icuType: 'Medical', icuRoomNameNo: 'R103', icuDescription: 'Medical ICU bed', isVentilatorAttached: false, status: 'active', createdAt: '2025-01-01T10:00:00Z', createdDate: '2025-01-01' },
